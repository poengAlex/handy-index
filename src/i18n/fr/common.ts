...
const common: typeof enUS = {
  ...
  state: {
    ...
    catalogErrorBody:
      "L'index des scripts n'a pas répondu. Vérifiez votre connexion, puis réessayez.",
  ...
  ofTotal: {
    ...
    tags: "{shown} sur {total} tag | {shown} sur {total} tags"
  },
  ...
  language: {
    label: "Langue",
    caption: "Choisissez la langue d'affichage du site",
