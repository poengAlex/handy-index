...
const sites: typeof enUS = {
  ...
  count: {
    ...
    premiumScripts:
      "{count} платный скрипт | {count} платных скрипта | {count} платных скриптов"
  },

  errorTitle: "Не удалось загрузить сайты",
  emptyBody:
    "Индекс вернулся без единого сайта. Попробуйте загрузить его снова.",
  noMatchTitle: "Сайты не найдены",
  noMatchBody:
    "Ни одно название сайта не совпало с запросом. Попробуйте ввести меньше букв."
};
