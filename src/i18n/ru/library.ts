...
const library: typeof enUS = {
  favorites: {
    ...
    emptyBody:
      "Нажмите на сердечко на странице любого видео — и оно сохранится здесь для быстрого доступа."
  },

  history: {
    title: "История просмотров",
    note: "Хранится только в этом браузере — история просмотров нигде не отслеживается и никуда не отправляется.",
    emptyTitle: "Вы пока ничего не смотрели",
    emptyBody:
      "Открытые вами видео запоминаются здесь — только на этом устройстве.",
    clearTitle: "Очистить историю просмотров?",
    clearBody:
      "Видео останутся в каталоге — исчезнет только список того, что вы открывали в этом браузере.",
