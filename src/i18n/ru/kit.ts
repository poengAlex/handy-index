...
const kit: typeof enUS = {
  ...
  slider: {
    ...
    editValue: "{label}: изменить значение",
    min: "{label}: минимальное значение",
    editMin: "{label}: изменить минимум",
    max: "{label}: максимальное значение",
    editMax: "{label}: изменить максимум"
  }
};
