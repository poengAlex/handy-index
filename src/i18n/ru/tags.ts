...
const tags: typeof enUS = {
  ...
  loading: {
    ...
    percent: "{percent}%",
    downloading: "Загружаем индекс скриптов",
  ...
  controls: {
    ...
    sortedDescTitle: "Сортировка по убыванию — нажмите, чтобы обратить порядок",
    sortedAscTitle:
      "Сортировка по возрастанию — нажмите, чтобы обратить порядок",
    muted: "Заглушённые",
  ...
  empty: {
    ...
    filteredBody:
      "Ваши фильтры и заглушённые теги скрывают все теги в индексе. Ослабьте их в настройках.",
